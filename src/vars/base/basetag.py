...
class BaseTag:
    ...
    def get_attributes_with_description(cls):
        return {
            ...
            "OBJECT_TAG":"this is a required attribute. this is a dictionary with one or more pairs of {'NAME':'VALUE'}. use get_tag_objects tool to get the list of tag objects, if none fit the need you can create a new tag object and pass it to this parameter."
        }
