...
class Privilege():
    ...
    "FILE FORMAT","PIPE","TASK","STAGE","STREAM","RESOURCE MONITOR","EXTERNAL VOLUME","FAILOVER GROUP","REPLICATION GROUP",
    "INTEGRATION","AUTHENTICATION POLICY","NETWORK RULE","NETWORK POLICY","PACKAGES POLICY","PASSWORD POLICY","PROVISIONED THROUGHPUT",
    "SESSION POLICY","DATA EXCHANGE","LISTING","ORGANIZATION PROFILE","CORTEX SEARCH SERVICE","CONNECTION","DYNAMIC TABLE","EVENT TABLE",
    "EXTERNAL TABLE","HYBRID TABLE","ICEBERG TABLE","VIEW","MATERIALIZED VIEW","SEMANTIC VIEW","NOTEBOOK","DATABASE ROLE","SECRET","AGGREGATION POLICY",
    "JOIN POLICY","MASKING POLICY","PRIVACY POLICY","PROJECTION POLICY","ROW ACCESS POLICY","TAG","SEQUENCE","STORED PROCEDURE","USER DEFINED FUNCTION",
    "EXTERNAL FUNCTION","DATA METRIC FUNCTION","ALERT","COMPUTE POOL","IMAGE REPOSITORY","SERVICE","SNAPSHOT","SNAPSHOT POLICY","SNAPSHOT SET",
    "STREAMLIT","MODEL","APPLICATION PACKAGE","CONTACT","DATASET"]

    _allowed_privileges = {
        "USER": ["MONITOR","OWNERSHIP","ALL","IMPERSONATE","MODIFY PROGRAMMATIC AUTHENTICATION METHODS"],
        "ROLE": ["OWNERSHIP"],
        "STAGE":["USAGE","READ","WRITE","OWNERSHIP","ALL"],
        "WAREHOUSE": ["APPLYBUDGET","MODIFY","MONITOR","OPERATE","USAGE","OWNERSHIP","ALL"],
        "DATABASE": ["APPLYBUDGET","MODIFY","MONITOR","USAGE","REFERENCE_USAGE","CREATE DATABASE ROLE","CREATE SCHEMA","IMPORTED PRIVILEGES","OWNERSHIP","EXECUTE AUTO CLASSIFICATION","ALL"],
        ...
        "RESOURCE MONITOR":["MODIFY","MONITOR","ALL"],
        "EXTERNAL VOLUME":["USAGE","OWNERSHIP"],
        "FAILOVER GROUP":["MODIFY","MONITOR","OWNERSHIP","FAILOVER","REPLICATE","ALL"],
        "REPLICATION GROUP":["MODIFY","MONITOR","OWNERSHIP","REPLICATE","ALL"],
        "INTEGRATION":["USAGE","USE_ANY_ROLE","OWNERSHIP","ALL"],
        "AUTHENTICATION POLICY":["OWNERSHIP"],
        "NETWORK RULE":["OWNERSHIP"],
        "NETWORK POLICY":["OWNERSHIP"],
        "PACKAGES POLICY":["OWNERSHIP","USAGE"],
        "PASSWORD POLICY":["OWNERSHIP"],
        "PROVISIONED THROUGHPUT":["OWNERSHIP","USE","MONITOR"],
        "SESSION POLICY":["OWNERSHIP"],
        "DATA EXCHANGE":["IMPORTED PRIVILEGES"],
        "LISTING":["MODIFY","USAGE","OWNERSHIP","ALL"],
        "ORGANIZATION PROFILE":["MODIFY","OWNERSHIP"],
        "SHARE":["OWNERSHIP"],
        "CORTEX SEARCH SERVICE":["USAGE","OPERATE","OWNERSHIP","ALL"],
        "CONNECTION":["FAILOVER"],
        "DYNAMIC TABLE":["SELECT","OPERATE","MONITOR","OWNERSHIP","ALL"],
        "EVENT TABLE":["ALL","APPLYBUDGET","DELETE","OWNERSHIP","REFERENCES","SELECT","TRUNCATE"],
        "EXTERNAL TABLE":["SELECT","REFERENCES","OWNERSHIP","ALL"],
        "HYBRID TABLE":["SELECT","INSERT","UPDATE","TRUNCATE","DELETE","REFERENCES","APPLYBUDGET","OWNERSHIP","ALL"],
        "ICEBERG TABLE":["SELECT","INSERT","UPDATE","TRUNCATE","DELETE","REFERENCES","APPLYBUDGET","OWNERSHIP","ALL"],
        "VIEW":["SELECT","REFERENCES","OWNERSHIP","ALL"],
        "MATERIALIZED VIEW":["SELECT","REFERENCES","APPLYBUDGET","OWNERSHIP","ALL"],
        "SEMANTIC VIEW":["SELECT","REFERENCES","OWNERSHIP","ALL"],
        "NOTEBOOK":["OWNERSHIP","USAGE"],
        "DATABASE ROLE":["OWNERSHIP"],
        "SECRET":["READ","USAGE","OWNERSHIP"],
        "AGGREGATION POLICY":["APPLY","OWNERSHIP"],
        "JOIN POLICY":["APPLY","OWNERSHIP"],
        "MASKING POLICY":["APPLY","OWNERSHIP"],
        "PRIVACY POLICY":["APPLY","OWNERSHIP"],
        "PROJECTION POLICY":["APPLY","OWNERSHIP"],
        "ROW ACCESS POLICY":["APPLY","OWNERSHIP"],
        "TAG":["APPLY","OWNERSHIP","READ"],
        "SEQUENCE":["USAGE","OWNERSHIP","ALL"],
        "STORED PROCEDURE":["USAGE","OWNERSHIP","ALL"],
        "USER DEFINED FUNCTION":["USAGE","OWNERSHIP","ALL"],
        "EXTERNAL FUNCTION":["USAGE","OWNERSHIP","ALL"],
        "DATA METRIC FUNCTION":["USAGE","OWNERSHIP","ALL"],
        "ALERT":["MONITOR","OPERATE","OWNERSHIP","ALL"],
        "COMPUTE POOL":["MONITOR","OPERATE","OWNERSHIP","MODIFY","USAGE"],
        "IMAGE REPOSITORY":["OWNERSHIP","READ","WRITE"],
        "SERVICE":["OPERATE","OWNERSHIP","MONITOR"],
        "SNAPSHOT":["OWNERSHIP","USAGE"],
        "SNAPSHOT POLICY":["OWNERSHIP","USAGE"],
        "SNAPSHOT SET":["OWNERSHIP","USAGE"],
        "STREAMLIT":["USAGE"],
        "MODEL":["OWNERSHIP","USAGE"],
        "APPLICATION PACKAGE":["ATTACH LISTING"],
        "CONTACT":["APPLY","MODIFY","OWNERSHIP"],
        "DATASET":["OWNERSHIP","USAGE"]
    }
