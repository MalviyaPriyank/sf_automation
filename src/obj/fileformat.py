...
class Operation:
    ...
    def create_object(session,user_id,kwargs,*largs):
        ...
        obj_inst.logger.info("set empty_field_as_null")
        ...
        obj_inst.logger.info("set skip_byte_order_mark")
        ...
        obj_inst.logger.info("set strip_outer_array")
        ...
        obj_inst.logger.info("set strip_null_values")
        ...
        obj_inst.logger.info("set ignore_utf8_errors")
        ...
        obj_inst.logger.info("set snappy_compression")
        ...
        obj_inst.logger.info("set binary_as_text")
        ...
        obj_inst.logger.info("set use_logical_type")
        ...
        obj_inst.logger.info("set use_vectorized_scanner")
        ...
        obj_inst.logger.info("set preserve_space")
        ...
        obj_inst.logger.info("set strip_outer_element")
        ...
        obj_inst.logger.info("set disable_snowflake_data")
        ...
        obj_inst.logger.info("set disable_auto_convert")
