...
class Compression:
    ...
    def __set__(self,instance,value):
        if instance._type == _csv_type: #CSV
...
class DateFormat:
    ...
    def __set__(self,instance,value):
        ...
        elif instance._type == gv_ff._allowed_values_type[0] or instance._type == gv_ff._allowed_values_type[1]:
            if type(value) != str:
                raise KeyError
            else:
...
class BinaryFormat:
    ...
    def __set__(self,instance,value):
        if value == "NONE":
            ...
            if value not in gv_ff._allowed_values_binary_format:
                raise KeyError
            else:
                instance._binary_format = value
